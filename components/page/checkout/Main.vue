        ...
        <div class="col-lg-8">
          ...
          <form class="needs-validation">
            ...
            <!-- <div class="form-check ps-0 mt-3 custome-form-check">
              ...
              />
              <label
                class="form-check-label checkout-label"
                for="flexCheckDefault11"
                >{{ useRuntimeConfig().public.const.SaveInfo }}</label
              >
            </div> -->
...
let saveUserInfo = ref(false),
  validInfo = ref(false),
  checkoutForm = ref(null),
  isLogin = ref(false),
  paymentMethod = ref("stripe"),
  userInfo = ref({}),
  user = ref({});
