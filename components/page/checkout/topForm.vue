  ...
  <div class="row g-4">
    ...
    <div class="col-md-5">
      ...
      >
        <option selected disabled value="">
          {{ useRuntimeConfig().public.const.Choose }}
        </option>
        <option
          v-for="(country, index) in useRuntimeConfig().public.const.CountryArr"
          :key="index"
        >
          {{ country }}
        </option>
    ...
    <!-- <div class="col-md-4">
      ...
      >
        ...
        <option
          v-for="(state, index) in useRuntimeConfig().public.const.StateArr"
          :key="'a' + index"
        >
          {{ state }}
        </option>
