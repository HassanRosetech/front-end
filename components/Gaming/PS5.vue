<template>
  <div class="tree-item">
    <span class="tree-label">PS5</span>
    <button @click="toggleCollapse('PS5')" class="tree-toggle">
      {{ collapsed["PS5"] ? "+" : "-" }}
    </button>
  </div>

  <ul v-show="!collapsed['PS5']" class="subcategory1 tree-children">
