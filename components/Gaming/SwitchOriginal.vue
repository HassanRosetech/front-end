<template>
  <div class="tree-item">
    <span class="tree-label">Switch (Original)</span>
    <button @click="toggleCollapse('Switch (Original)')" class="tree-toggle">
      {{ collapsed["Switch (Original)"] ? "+" : "-" }}
    </button>
  </div>

  <ul
    v-show="!collapsed['Switch (Original)']"
  ...
  >
    ...
    <li>
      ...
      <div class="tree-item">
        ...
        >
          <li>
            <NuxtLink to="#">Konsol väska</NuxtLink>
          </li>
