<template>
  <div class="tree-item">
    <span class="tree-label">XSeries + XOne</span>
    <button @click="toggleCollapse('XSeries + XOne')" class="tree-toggle">
      {{ !collapsed["XSeries + XOne"] ? "+" : "-" }}
    </button>
  </div>

  <ul v-show="collapsed['XSeries + XOne']" class="subcategory1 tree-children">
    <li>
