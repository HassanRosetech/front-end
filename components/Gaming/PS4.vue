<template>
  <div class="tree-item">
    <span class="tree-label">PS4</span>
    <button @click="toggleCollapse('PS4')" class="tree-toggle">
      {{ collapsed["PS4"] ? "+" : "-" }}
    </button>
  </div>

  <ul v-show="!collapsed['PS4']" class="subcategory1 tree-children">
    <li><NuxtLink to="#">Kablar</NuxtLink></li>
    <li>
      <NuxtLink to="#">Laddningsstationer</NuxtLink>
    </li>
    <li>
      ...
      <div class="tree-item">
        ...
        >
          ...
          <li>
            <NuxtLink to="#">Silikon hölje Kit</NuxtLink>
          </li>
          <li>
            <NuxtLink to="#">Handkontrollgrepp</NuxtLink>
          </li>
          <li><NuxtLink to="#">Hel set</NuxtLink></li>
        </ul>
      </div>
    </li>
    <li>
      ...
      <div class="tree-item">
        ...
        >
          <li>
            <NuxtLink to="#">Handkontroll</NuxtLink>
          </li>
        </ul>
      </div>
    </li>
    <li>
      ...
      <div class="tree-item">
        ...
        >
          <li>
            <NuxtLink to="#">DC Batman</NuxtLink>
          </li>
          <li>
            <NuxtLink to="#">Dragon Ball</NuxtLink>
          </li>
          <li>
            <NuxtLink to="#">One Piece</NuxtLink>
          </li>
          <li>
            <NuxtLink to="#">Resident Evil</NuxtLink>
          </li>
          <li>
            <NuxtLink to="#">Tanooki</NuxtLink>
          </li>
          <li>
            <NuxtLink to="#">Captain Tsubasa</NuxtLink>
          </li>
        </ul>
      </div>
    </li>
