<template>
  <div class="tree-item">
    <span class="tree-label">Switch (Oled)</span>
    <button @click="toggleCollapse('Switch (Oled)')" class="tree-toggle">
      {{ collapsed["Switch (Oled)"] ? "+" : "-" }}
    </button>
  </div>

  <ul v-show="!collapsed['Switch (Oled)']" class="subcategory1 tree-children">
    <li>
