<template>
  <div class="tree-item">
    <span class="tree-label">Väskor och fodral</span>
    <button @click="toggleCollapse('Väskor och fodral')" class="tree-toggle">
  ...
  >
    <li><NuxtLink to="#">Handkontroll (Alla standardkontroller)</NuxtLink></li>
  </ul>
</template>
