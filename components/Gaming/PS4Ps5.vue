<template>
  <div class="tree-item">
    <span class="tree-label">PS4 + PS5</span>
    <button @click="toggleCollapse('PS4 + PS5')" class="tree-toggle">
      {{ collapsed["PS4 + PS5"] ? "+" : "-" }}
    </button>
  </div>

  <ul v-show="!collapsed['PS4 + PS5']" class="subcategory1 tree-children">
    <li>
